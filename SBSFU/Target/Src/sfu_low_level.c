...
/* RTC HAL init/deinit removed for the F072 port: the bootloader accesses the
 * RTC backup registers directly (CMSIS) from main.c, the HAL RTC module is
 * not compiled and the tamper protection is not ported. */
