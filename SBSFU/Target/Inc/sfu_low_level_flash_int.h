...
/* STM32F0: the atomic write access type is one 32-bit word (HAL programs it
 * as two half-words; half-word is the hardware minimum on this family) */
...
/* The F0 CMSIS/HAL only defines FLASH_PAGE_SIZE (2K); SBSFU code inherited
 * from sector-based families uses FLASH_SECTOR_SIZE for the erase granule. */
