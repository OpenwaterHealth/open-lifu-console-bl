...
/**
  * @brief SHA3/224 Hash structure for the RSA PKCS#1 v1.5 functions
  */
extern const cmox_rsa_pkcs1v15_hash_t CMOX_RSA_PKCS1V15_HASH_SHA3_224;
/**
  * @brief SHA3/256 Hash structure for the RSA PKCS#1 v1.5 functions
  */
extern const cmox_rsa_pkcs1v15_hash_t CMOX_RSA_PKCS1V15_HASH_SHA3_256;
/**
  * @brief SHA3/384 Hash structure for the RSA PKCS#1 v1.5 functions
  */
extern const cmox_rsa_pkcs1v15_hash_t CMOX_RSA_PKCS1V15_HASH_SHA3_384;
/**
  * @brief SHA3/512 Hash structure for the RSA PKCS#1 v1.5 functions
  */
extern const cmox_rsa_pkcs1v15_hash_t CMOX_RSA_PKCS1V15_HASH_SHA3_512;
...
/**
  ...
  * @warning RSA PKCS#1 v1.5 is kept for compatibility only. Please, for new applications, consider using the newer
  *          RSA PKCS#1 v2.2, that is no susceptible to some side-channel attacks (e.g., Bleichenbacher attack).
  * @{
  */
...
/**
  ...
  * @note        P_InputLen <= length(modulus) - 11
  * @note        P_pRandom must contain at least (length(modulus) - P_InputLen - 3) not-null bytes
  * @retval      CMOX_RSA_SUCCESS                   Everything OK
  * @retval      CMOX_RSA_ERR_MATH_ALGO_MISMATCH    Mathematical function set is incompatible with current functionality
  * @retval      CMOX_RSA_ERR_MEXP_ALGO_MISMATCH    Modexp function set is not compatible with current functionality
  * @retval      CMOX_RSA_ERR_BAD_PARAMETER         Some NULL/wrong/empty parameter
