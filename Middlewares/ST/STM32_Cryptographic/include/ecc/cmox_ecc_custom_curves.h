...
/**
  ...
  * @warning    The curve must be in Short-Weierstrass form and must have cofactor equal to 1.
  * @warning    The curve can be used with ECDSA and ECDH algorithms only.
  */
