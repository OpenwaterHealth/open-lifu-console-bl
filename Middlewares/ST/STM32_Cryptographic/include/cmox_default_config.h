...
/**
  * @defgroup CMOX_PQC_DEFAULT Default PQC customizations
  * @{
  */
#define CMOX_PQC_FAST 0x01U

#define CMOX_PQC_SMALL 0x02U


#define CMOX_PQC_IMPLEMENTATION CMOX_PQC_SMALL
