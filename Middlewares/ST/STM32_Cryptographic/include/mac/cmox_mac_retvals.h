...
/**
  ...
  */
#define CMOX_MAC_ERR_BAD_INPUT_SIZE             ((cmox_mac_retval_t)0x00030005U)
...
/**
  * @brief Alternative implementation function not implemented
  */
#define CMOX_MAC_ERR_NO_ALT_IMPL                ((cmox_mac_retval_t)0x0003000D)
