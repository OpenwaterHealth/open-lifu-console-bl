...
/** @defgroup CMOX_KDF KDF module
  * @{
  */

#include "kdf/cmox_hkdf.h"
...
/** @defgroup CMOX_PQC PQC module
  * @{
  */
#include "pqc/cmox_pqc_kem.h"
#include "pqc/cmox_pqc_dsa.h"
/**
  * @}
  */

/** @defgroup CMOX_HBS HBS module
  * @{
  */
#include "hbs/cmox_hbs.h"
/**
  * @}
  */
