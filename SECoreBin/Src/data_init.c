...
{
	extern uint8_t* _sidata asm("_se_sidata");
	extern uint8_t* _sdata asm("_se_sdata");
	extern uint8_t* _edata asm("_se_edata");
...
{
	extern uint8_t* _sbss asm("_se_sbss");
	extern uint8_t* _ebss asm("_se_ebss");
