...
Usage:
    ...
    python flash_firmware.py read 0x08010000 320       # dump the signed header
...
DEFAULT_ADDR = 0x08010000        # SBSFU active slot (signed image base)
...
def cmd_erase(args):
    print("Erasing the application slot (0x08010000–0x0801EFFF)...")
    print()
    with STM32DFU() as dfu:
        dfu.connect(serial=args.serial)
        t0 = time.monotonic()
